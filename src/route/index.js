...
//=========Блок змінних=================
// var address='м. Київ, вул. Хрещатик б.22, а\я №1'
...
var header = {
  ...
  salary: '600$ в місяць',
  address:'м. Київ, вул. Хрещатик б.22, а\я №1',
}
...
var footer =  {
  social: {
    email: {
      ...
      href: 'mailto:ivanov.dmytro@mail.com',
    },
    phone: {
      text: '+380670000123',
...
//           ↙ тут вводимо шлях (PATH) до сторінки
router.get('/pagecss', function (req, res) {
  // res.render генерує нам HTML сторінку
...
// ================================================================
//           ↙ тут вводимо шлях (PATH) до сторінки
router.get('/bootstrap-nav', function (req, res) {
  // res.render генерує нам HTML сторінку
...
//           ↙ тут вводимо шлях (PATH) до сторінки
router.get('/bootstrap-field', function (req, res) {
  // res.render генерує нам HTML сторінку

  //            ↙ cюди вводимо назву файлу з сontainer
  res.render('bootstrap_field', {
    layout:'bootstrap',
  })
  //                  ↑↑ сюди вводимо JSON дані
})
  ...
  res.render('skills', {
    ...
    main: {
      ...
      hobbies:[
        ...
        {name: 'ІТ навчання', isMain: true,},
        {name: 'копм"ютерні ігри', isMain: false ,},
...
router.get('/education', function (req, res) {
  ...
  res.render('education', {
    ...
    main: {
      educations:[
        {name:'НТУУ КПІ', isEnd: true,},
        {name:'Києво- Могилянська академія', isEnd: false,},
        {name:'Київський коледж зв"язку', isEnd: true,},
        {name:'курси ІТ Brains', isEnd: false,},
      ],
      certificates:[
        {name: 'атестат про закінчення с.ш№', id: 2525,},
        {name: 'диплом спеціаліста ', id: 3535,},
        {name: 'диплом бакалавра', id:4545,},
      ...
      projects:[
        {
          name:'Resume',
          url:'https://rabota.ua/',
          about:'Airbnb competitors and alternative booking sites ',
          stacks:[
            {
            name: 'React.js',
          },
...
router.get('/template-1', function (req, res) {
	...
	res.render('template-1', {
	  ...
	  hero: {
		title: 'Pricing',
		text: `Quickly build an effective 
		pricing table for your potential

		 customers with this Bootstrap

		  example.  It's built with 

		  default Bootstrap components
		  and utilities with little 
		  customization.`,
	  },
	  plans: [
		{
